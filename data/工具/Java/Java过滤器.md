> HTML 页面: [[page/wiki/data/工具/Java/Java过滤器.html|打开 HTML 页面]]

### filter也称之为过滤器，它是[javaWeb](https://so.csdn.net/so/search?q=javaWeb&spm=1001.2101.3001.7020)三大组件之一（Servlet程序、Listener监听器、Filter过滤器）, 既可以对请求进行拦截，也可以对响应进行处理.
...
**同样，如果前后端交互有遇到跨域问题的，也可以通过Filter解决（亲测有效）**
